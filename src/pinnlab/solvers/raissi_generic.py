...
Usage
-----
1) Drop this module next to your existing `pinnlab.solvers.raissi` module (or use standalone).
...
# latin_hypercube is imported from pinnlab.sampling.core. It used to be defined
